 ...
 <div class="container-fluid bg-footer bg-primary text-white mt-5">
    ...
    <div class="container-fluid bg-dark text-white py-4">
        <div class="container text-center">
            <p class="mb-0">&copy; <a class="text-secondary fw-bold" href="#">HomeSteaderIndia.Com</a>. All Rights Reserved. Designed And Developed by <a class="text-secondary fw-bold" href="https://www.linkedin.com/in/jayshri-naikwadi-b296a7296/">Jayshri Naikwadi</a></p>
        </div>
    </div>
    <!-- Footer End -->
