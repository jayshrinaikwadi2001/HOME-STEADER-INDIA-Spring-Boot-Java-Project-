        ...
        <div class="row gx-5 py-3 align-items-center">
            <div class="col-lg-3" style="color: darkslategrey;font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman',">
                <div class="d-flex align-items-center justify-content-start">
                    ...
                    <h2 class="mb-0">+91 7887962695</h2>
                </div>
            </div>
            <div class="col-lg-6">
            ...
            <div class="col-lg-3">
               <div class="d-flex align-items-center justify-content-end">
                    <a class="btn btn-primary btn-square rounded-circle me-2" href="https://www.linkedin.com/in/jayshri-naikwadi-b296a7296/"><i class="fab fa-linkedin-in"></i></a>
                    <a class="btn btn-primary btn-square rounded-circle" href="https://www.instagram.com/jayshri.n_20/"><i class="fab fa-instagram"></i></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="row g-0">
                        <div class="col-10">
                            <div class="position-relative">
                                <img class="img-fluid w-100" src="img/team13.jpeg" alt="" style="height: 400px;">
                                <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4" style="background: rgba(52, 173, 84, .85);">
                                    <h4 class="text-white">Jayshri Naikwadi </h4>
   ...
   <div class="container-fluid py-5">
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="text-white mb-0">jayshrinaikwadi2001@gmail.com</p>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-telephone text-white me-2"></i>
                                <p class="text-white mb-0">7887962696</p>
                            </div>
                            <div class="d-flex mt-4">
                                <a class="btn btn-secondary btn-square rounded-circle me-2" href="https://www.linkedin.com/in/jayshri-naikwadi-b296a7296/"><i class="fab fa-linkedin-in"></i></a>
                                <a class="btn btn-secondary btn-square rounded-circle" href="https://www.instagram.com/jayshri.n_20/"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
    ...
    <div class="container-fluid bg-dark text-white py-4">
        <div class="container text-center">
            <p class="mb-0">&copy; <a class="text-secondary fw-bold" href="#">HomeSteaderIndia.Com</a>. All Rights Reserved. Designed And Developed by <a class="text-secondary fw-bold" href=>Jayshri Naikwadi</a></p>
        </div>
    </div>
    <!-- Footer End -->
